...
export default function ConfiguracoesConsumidor() {
  ...
  // Função para navegação (pode ser conectada com sua navegação real)
  const handleNavigate = (screen, param) => {
    console.log(`Navegar para: ${screen}`, param);
    // Aqui você conectaria com sua navegação real (React Navigation, etc.)
  ...
  return (
    <View style={styles.container}>
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
        {/* Photo Section - AGORA MAIS ABAIXO */}
...
const styles = StyleSheet.create({
  ...
  scrollContent: {
    paddingBottom: 10, // Adiciona espaço no final
  },
  loadingContainer: {
    flex: 1,
    backgroundColor: '#ffffff',
  ...
  photoSection: {
    alignItems: 'center',
    paddingVertical: 80, // AUMENTADO de 30 para 80 (mais espaço acima)
    paddingHorizontal: 20,
    marginTop: 20, // ADICIONADO para descer ainda mais
  },
  photoContainer: {
    alignItems: 'center',
    justifyContent: 'center',
